    ...
    <div className={`control-panel ${showControls ? 'mobile-visible' : ''}`}>
      ...
      <div className={`panel-body${collapsed ? ' collapsed' : ''}`}>
        ...
        <div className="mb-1 last:mb-0">
          ...
          >
            <span>Filters</span>
            <span className={clsx('text-sm font-normal opacity-70 transition-transform duration-300', sectionsOpen.filters && 'rotate-180')}>+</span>
          </button>
        ...
        <div className="mb-1 last:mb-0">
          ...
          >
            <span>Style</span>
            <span className={clsx('text-sm font-normal opacity-70 transition-transform duration-300', sectionsOpen.style && 'rotate-180')}>+</span>
          </button>
          {sectionsOpen.style && (
            <div className="p-3 bg-black/15 rounded-b-lg border-t border-accent/15 animate-[expandDown_0.3s_cubic-bezier(0.16,1,0.3,1)] origin-top">
              <div className="mb-3.5 last:mb-0">
        ...
        <div className="mb-1 last:mb-0">
          ...
          >
            <span>Display</span>
            <span className={clsx('text-sm font-normal opacity-70 transition-transform duration-300', sectionsOpen.display && 'rotate-180')}>+</span>
          </button>
        ...
        <div className="mb-1 last:mb-0">
          ...
          >
            ...
            <span className={clsx('text-sm font-normal opacity-70 transition-transform duration-300', sectionsOpen.appearance && 'rotate-180')}>+</span>
          </button>
